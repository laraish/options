...
class UrlFieldGenerator extends BaseFieldGenerator
{
    /**
     * The default configs.
     * @var array
    ...
    final public function generate()
    {
        ...
        return "<input type=\"url\" {$allAttributes}>" . $this->generateDescription();
    }
    ...
    {
        return $this->validateWithErrorMessage($value, "`{$this->config('title')}` must be a URL.");
    }
